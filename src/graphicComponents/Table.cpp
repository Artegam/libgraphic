...
Table::Table (const int window, const int x, const int y, const unsigned int rows, const unsigned int cols, string defaultval, const string name): GraphicLeaf(window, x, y, name) {
