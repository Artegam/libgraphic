...
Menu::Menu (const int window, const int x, const int y, list<string> items, const string name) : Composite (window, x, y, name) {
...
Menu::Menu (const int window, const int x, const int y, list<Text *> items, const string name) : Composite (window, x, y, name) {
  _items = items;
